...
#### Preprocessing ####
typhoid11 <- read_excel(typhoid, sheet = "2011")
typhoid12 <- read_excel(typhoid, sheet = "2012")
typhoid13 <- read_excel(typhoid, sheet = "2013")
typhoid14 <- read_excel(typhoid, sheet = "2014")
typhoid15 <- read_excel(typhoid, sheet = "2015")
typhoid16 <- read_excel(typhoid, sheet = "2016")
typhoid17 <- read_excel(typhoid, sheet = "2017")
typhoid18 <- read_excel(typhoid, sheet = "2018")

abd11 <- read_excel(abd, sheet = "2011")
abd12 <- read_excel(abd, sheet = "2012")
abd13 <- read_excel(abd, sheet = "2013")
abd14 <- read_excel(abd, sheet = "2014")
abd15 <- read_excel(abd, sheet = "2015")
abd16 <- read_excel(abd, sheet = "2016")
abd17 <- read_excel(abd, sheet = "2017")
abd18 <- read_excel(abd, sheet = "2018")
